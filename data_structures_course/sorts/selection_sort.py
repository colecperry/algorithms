# Selection sort 
    ...
    # Sorted!: Each time, the current position gets sorted, and you work on the rest of the list.
...
def selection_sort(array):
    min_index = 0
    for i in range(len(array) - 1): # Iterate through the list
        min_index = i # Set minimum index to i to track the position in the outer loop
        for j in range(i+1, len(array)): # Iterate through the list again starting with (j= (i + 1)) one index after i until the end of the list 
